...
async def about_bot(message: Message):
    await message.answer(
        ...
        "bepul tomosha qilishingiz, reyting qo'yishingiz, o'z dublyajingizni "
        "yuklashingiz va oylik sovrinlar uchun kurashishingiz mumkin! 🚀\n\n"
        ...
        "⭐ reyting) va \"🎬 Epizodlar\" tugmasi chiqadi.\n\n"
        ...
        "6️⃣ ⭐ <b>Baho berish</b> — bir animening kamida bitta epizodini "
        "ko'rgandan so'ng, uning sahifasida \"⭐ Baholash\" tugmasi orqali "
        "1-5 yulduz qo'yishingiz mumkin.\n\n"
        "👑 <b>VIP</b> — ba'zi animelar faqat VIP foydalanuvchilarga ochiq. "
        "VIP holatingizni shu tugma orqali tekshirishingiz mumkin.\n\n"
        "🏆 <b>TOP bo'limi</b> — bu yerda:\n"
        "  • 👤 Eng ko'p epizod ko'rgan foydalanuvchilar\n"
        "  • 🌟 Eng yuqori baholangan animelar\n"
        "  • 🎙 Foydalanuvchilar yuklagan dublyajlar (o'zingiz ham \"🎙 Dublyaj "
        "yuklash\" orqali video yuborib, boshqalar tomonidan baholanishingiz mumkin!)\n"
        "  • 🎁 <b>Oylik sovrinlar</b> — har oyning 1-sanasida eng faol "
        "tomoshabin va eng zo'r dublyajchiga 👑 <b>Telegram Premium</b> sovrin "
        "sifatida beriladi!\n\n"
        "🤖 <b>AI yordamchi</b> — botga oddiy savol yozsangiz (masalan salom, "
        "tavsiya so'rash va h.k.), yoki rasm/PDF/matn fayl yuborsangiz, sun'iy "
        "intellekt sizga javob beradi.\n\n"
